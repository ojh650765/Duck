...
def build_body():
    ...
    # --- distinct neck step: a narrow column, clearly thinner than the shoulders
    neck = [
        ring_z(N, 0.268, 0.042, 0.044, 2.0, 0.0, -0.056),
        ring_z(N, 0.292, 0.040, 0.042, 2.0, 0.0, -0.053),
        ring_z(N, 0.316, 0.044, 0.046, 2.0, 0.0, -0.050),
    ]
    mb.loft(neck, CREAM, cap_a=False, cap_b=False)
...
def build_head():
    ...
    HEAD = [
        (0.316, 0.045, 0.048, 0.046, -0.050, 2.0),
    ...
    head_faces, _ = mb.pole_loft(rings, CREAM, pole_b=(0.0, -0.046, 0.456))
    # close the bottom of the skull onto the neck
    mb.loft([ring_z(N, 0.316, 0.044, 0.046, 2.0, 0.0, -0.050), rings[0]],
